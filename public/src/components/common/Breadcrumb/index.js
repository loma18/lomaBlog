		...
		switch (pathname[1]) {
			...
			case 'original':
				routes.push({
					path: '/' + pathname[1],
					breadcrumbName:
						breadcrumbItem[pathname[1]] &&
						breadcrumbItem[pathname[1]].title
				});
				break;
			case 'reprint':
				routes.push({
			...
			case 'admin':
				if (!pathname[2]) {
					...
					routes.push({
						...
						breadcrumbName:
							breadcrumbItem[pathname[2]] &&
							breadcrumbItem[pathname[2]].title
					});
				} else {
					routes.push({
						path: '/' + pathname[1],
					...
					routes.push({
						...
						breadcrumbName:
							breadcrumbItem[pathname[3]] &&
							breadcrumbItem[pathname[3]].title
					});
				}
				break;
			default:
